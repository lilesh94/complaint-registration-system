...
<body>
    ...
    <div class="auto-style1">
        ...
        <asp:SqlDataSource ID="wantedDetails" runat="server" ConnectionString="Data Source=LILESH\SQLSERVER;Initial Catalog=myonlinecomplaints;Persist Security Info=True;User ID=sa;Password=12345" ProviderName="System.Data.SqlClient" SelectCommand="SELECT [name], [age], [address], [height], [color], [special_mark], [last_seen] FROM [wanted] WHERE ([id] = @id)">
            <SelectParameters>
