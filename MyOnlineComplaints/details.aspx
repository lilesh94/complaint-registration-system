<%@ Page Title="Details" Language="C#" MasterPageFile="~/users.Master" AutoEventWireup="true" CodeBehind="details.aspx.cs" Inherits="MyOnlineComplaints.WebForm11" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <br />
        ...
        <asp:TextBox ID="add" runat="server" Height="53px" MaxLength="100" style="margin-left: 119px; resize:none;" TextMode="MultiLine" Rows="5" CssClass="textbox"></asp:TextBox>
        ...
        &nbsp;<asp:TextBox ID="mob" runat="server" style="margin-left: 70px" MaxLength="10" CssClass="textbox"></asp:TextBox>
        ...
        <asp:TextBox ID="altmob" runat="server" style="margin-left: 13px" MaxLength="10" CssClass="textbox"></asp:TextBox>
        ...
        <asp:TextBox ID="altemail" runat="server" style="margin-left: 54px" CssClass="textbox"></asp:TextBox>
...
<asp:ListItem>1996</asp:ListItem>
        ...
        <asp:TextBox ID="age" runat="server" Enabled="False" ReadOnly="True" style="margin-left: 85px" Width="57px" CssClass="textbox"></asp:TextBox>
        <br />
        <br />
        <asp:Label ID="Label9" runat="server" Text="Aadhar Card Number:"></asp:Label>
        <asp:TextBox ID="aadhar" runat="server" MaxLength="12" style="margin-left: 33px" CssClass="textbox"></asp:TextBox>
