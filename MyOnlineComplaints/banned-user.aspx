...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <br />
        ...
        <asp:SqlDataSource ID="users" runat="server" ConnectionString="<%$ ConnectionStrings:dbcon %>" SelectCommand="SELECT photos.photo, users.user_id, users.user_name, users.user_email FROM users FULL JOIN photos ON users.user_id = photos.user_id WHERE (users.user_type = 'User') AND (users.verified = 'False')"></asp:SqlDataSource>
    </form>
