...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   ...
   <br />
        ...
        <asp:DropDownList ID="DropDownList1" runat="server" style="margin-left: 48px" AutoPostBack="True" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged" DataSourceID="stnName" DataTextField="user_name" DataValueField="user_name" AppendDataBoundItems="true">
            <asp:ListItem Selected="True">Select Police Station</asp:ListItem>
            <asp:ListItem>Other</asp:ListItem>
        </asp:DropDownList>
        <asp:SqlDataSource ID="stnName" runat="server" ConnectionString="Data Source=LILESH\SQLSERVER;Initial Catalog=myonlinecomplaints;Persist Security Info=True;User ID=sa;Password=12345" ProviderName="System.Data.SqlClient" SelectCommand="SELECT [user_name] FROM [users] WHERE ([user_type] = @user_type)">
            <SelectParameters>
        ...
        <asp:TextBox ID="other_station" runat="server" style="margin-left: 33px" Enabled="False" CssClass="textbox"></asp:TextBox>
        <br />
        <br />
        <asp:Label ID="Label4" runat="server" Text="Subject:"></asp:Label>
        <asp:TextBox ID="subject" runat="server" style="margin-left: 124px" CssClass="textbox"></asp:TextBox>
        ...
        <asp:TextBox ID="address" runat="server" style="margin-left: 63px" CssClass="textbox"></asp:TextBox>
        <br />
        <br />
    ...
    <script type="text/javascript">
        ...
        <asp:TextBox ID="date" runat="server" style="margin-left: 84px" Enabled="True" CssClass="textbox"></asp:TextBox>
        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="date" ErrorMessage="Invalid Date" ValidationExpression="^(?:0?[1-9]|1[0-2])[./-](?:[012]?[0-9]|3[01])[./-](?:[0-9]{2}){1,2}$">*</asp:RegularExpressionValidator>
        <br />
        <br />
        <asp:Label ID="Label7" runat="server" Text="Your Complaint:"></asp:Label>
        <br />
        <asp:TextBox ID="complaint" runat="server" style="margin-left: 170px; resize:none;" TextMode="MultiLine" Height="47px" CssClass="textbox"></asp:TextBox>
